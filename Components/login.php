...
<div id="page-container">
    <nav class="navbar navbar-light navbar-expand-md sticky-top" id="my-navbar" style="background: #577399;border-radius: 0;border-bottom-right-radius: 7px;border-bottom-left-radius: 7px;">
        <div class="container-fluid"><a class="navbar-brand" id="header-links" href="../" style="font-size: 30px;">StudyShare</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse justify-content-end" id="navcol-1" style="color: rgb(255,255,255);">
                ...
                { echo '
                    ...
                    <li class="nav-item">
                    <a class="nav-link active" id="header-links" href="<?php if(isset($_SESSION['user'])){echo "Components/logout.php";} else {echo "";}?>" style="padding: 8px;"><?php if(isset($_SESSION['user'])){echo "Logout";} else {echo "Anmelden";}?></a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link d-inline-flex" id="header-links" href="<?php if(isset($_SESSION['user'])){echo "#Profil";} else {echo "signup.php";}?>" style="background: #fe5f55;border-radius: 16px;padding: 8px;"><?php if(isset($_SESSION['user'])){echo "Profil";} else {echo "Registrieren";}?></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="form-container">
            <form id="Anmelden_Form">
            <div class="form-group text-center" style="padding-left: 20%; padding-right: 20%;">
                <h1 style="border-bottom: 2px solid gray;">Willkommen zurück!</h1>
            </div>
            <div class="form-group">
                ...
                <div class="form-group">
                    <button type="button" class="form-control" id="Anmelden" style="background: #fe5f55;border-radius: 16px;padding: 8px; color: white;">Anmelden</button>
                </div>
                <p id="fail_log">Anmelden fehlgeschlagen! Bitte erneut versuchen</p>
            </form>
        </div>
    </section>
